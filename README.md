...
Matchbox currently provides an compiler pipeline, bytecode VM, and a small standard/native runtime. The repository is still evolving, so the `tests/` directory contains a mix of working examples, regression inputs, and planned language behavior.
