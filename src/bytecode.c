...
static int printInstruction(int8_t c)
{
    switch (c) {
        ...
        case OP_LDL_0:      return printf("ldl 0\n");
        case OP_LDL_1:      return printf("ldl 1\n");
        case OP_LDL_2:      return printf("ldl 2\n");
        case OP_LDL_3:      return printf("ldl 3\n");
        case OP_STL:        return printf("stl\t\t%d\n", READ_INT8());
        case OP_STL_0:      return printf("stl 0\n");
        case OP_STL_1:      return printf("stl 1\n");
        case OP_STL_2:      return printf("stl 2\n");
        case OP_STL_3:      return printf("stl 3\n");
        case OP_PUSHB:      return printf("push\t\t%d\n", READ_INT8());
        case OP_PUSHH:      return printf("push\t\t%d\n", READ_INT16());
        case OP_PUSH_N1:    return printf("push -1\n");
        case OP_PUSH_0:     return printf("push 0\n");
        case OP_PUSH_1:     return printf("push 1\n");
        case OP_PUSH_2:     return printf("push 2\n");
        case OP_PUSH_3:     return printf("push 3\n");
